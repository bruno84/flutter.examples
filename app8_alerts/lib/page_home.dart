...
class PageHome extends StatelessWidget
{
  ...
  /*
  Dica 1: pode-se criar um builder para obter o contexto da tela, para não ter
          que vir passando o context láaaaa do Scaffold.
  Dica 2: Alt+Enter sobre o elemento que sofrerá o encapsulamento de outro.
          No caso, ElevatedButton já existia e foi envolvido por Builder.
   */
  _button(int type) {
    return Builder(
      builder: (context) {
