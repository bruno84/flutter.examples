import 'package:app_10_01_form/comp/comp_elevatedbutton.dart';
import 'package:app_10_01_form/comp/comp_textformfield.dart';
import 'package:app_10_01_form/pages/page_home.dart';
import 'package:app_10_01_form/utils/util_prefs.dart';
...
class _PageLogin extends State<PageLogin>
{
  ...
  _initForm() async //opção1
  {
    ...
    userEmail = await UtilPrefs.getString("email");
  ...
  Future<void> _onClickLogin() async
  {
    ...
    UtilPrefs.setString("email", email);
